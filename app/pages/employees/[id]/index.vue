<template>
  <div>
              ...
              <v-row dense>
                ...
                <v-col cols="2" class="text-right">
                  <!-- <v-btn icon="mdi-open-in-new" variant="text" color="info"></v-btn> -->
                   <v-btn icon="mdi-file-search" variant="text" color="blue-grey" @click="previewPayslip(payslip)"></v-btn>
                </v-col>
              </v-row>
              <v-divider></v-divider>
            </div>
    ...
    <v-dialog v-model="previewPayslipDialog" max-width="800" scrollable>
      <v-card >
        <v-toolbar>
          <v-toolbar-title><v-icon start>mdi-file-search</v-icon> Preview Payslip</v-toolbar-title> <v-spacer></v-spacer>
